...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
        ...
        _______, UG_TOGG, UG_NEXT, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, UG_VALU, UG_VALD, _______, KC_PSCR, _______, _______, QK_BOOT,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_INS , KC_HOME, KC_PGUP,          _______,
        _______, _______, _______, _______, BL_DOWN, BL_TOGG, BL_UP,   BL_STEP, _______, KC_DEL , KC_END , KC_PGDN, _______, _______,
