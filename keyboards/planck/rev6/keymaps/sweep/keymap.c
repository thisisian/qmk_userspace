...
#define MOD_QUOT RGUI_T(KC_QUOT)
    ...
    [_QWERTY] = LAYOUT_planck_grid(
        ...
        SETT, XXXXXXX, XXXXXXX, XXXXXXX, SYM, KC_LSFT, KC_SPC, EXT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX),
...
#define MOD_ENT RGUI_T(KC_ENT)
    ...
    [_SYM] = LAYOUT_planck_grid(
        KC_ASTR, KC_MINS, KC_LT, KC_GT, KC_PIPE, _______, _______, KC_CIRC, KC_LCBR, KC_RCBR, KC_DLR, KC_DEL,
        MOD_EXLM, MOD_UNS, MOD_SLS, MOD_EQL, KC_AMPR, _______, _______, KC_HASH, MOD_LPN, MOD_RPN, MOD_QUES, XXXXXXX,
        KC_TILD, KC_PLUS, KC_LBRC, KC_RBRC, KC_PERC, _______, _______, KC_AT, KC_GRV, KC_BSLS, XXXXXXX, XXXXXXX,
...
#define MOD_6 LSFT_T(KC_6)
    ...
    [_EXT] = LAYOUT_planck_grid(
        KC_TAB, KC_7, KC_8, KC_9, VIM_SAVE, _______, _______, KC_END, KC_PGDN, KC_PGUP, KC_HOME, KC_INS,
        KC_LGUI, MOD_4, MOD_5, MOD_6, KC_0, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX,
        XXXXXXX, KC_1, KC_2, KC_3, XXXXXXX, _______, _______, MOUSE, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI,
...
#define MOD_F6 LSFT_T(KC_F6)
    ...
    [_ADJUST] = LAYOUT_planck_grid(
        XXXXXXX, KC_F7, KC_F8, KC_F9, KC_F10, _______, _______, KC_PSCR, CW_TOGG, XXXXXXX, XXXXXXX, XXXXXXX,
        KC_LGUI, MOD_F4, MOD_F5, MOD_F6, KC_F11, _______, _______, XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI,
        XXXXXXX, KC_F1, KC_F2, KC_F3, KC_F12, _______, _______, XXXXXXX, XXXXXXX, TOGG_LO, DB_TOGG, QK_BOOT,
 ...
 */
    ...
    [_MOUSE] = LAYOUT_planck_grid(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR, XXXXXXX,
        KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, _______, _______, MS_LEFT, MS_DOWN, MS_UP, MS_RGHT, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, MOUSE, MS_ACL0, MS_ACL1, MS_ACL2, XXXXXXX,
